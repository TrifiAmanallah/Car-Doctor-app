		                   ...
		                   public void onClick(View aView)
			                {
		                	  ...
		                	  if(ancienne_date.after(nouvelle_date)) Toast.makeText(getApplicationContext(), "Erreur saisie date dernière vidange" ,Toast.LENGTH_LONG).show();  
		                	  else if(vidange._kilometrage > nouveau_vidange._kilometrage) Toast.makeText(getApplicationContext(), "Erreur saisie kilometrage dernière vidange" ,Toast.LENGTH_LONG).show();
		                	  else { 
		                            //test saisie bougies
		                	       ...
		                	       if(ancienne_date.after(nouvelle_date)) Toast.makeText(getApplicationContext(), "Erreur saisie date dernier changement bougies" ,Toast.LENGTH_LONG).show();  
		                	        ...
		                	        if(ancienne_date.after(nouvelle_date)) Toast.makeText(getApplicationContext(), "Erreur saisie date dernier changement filtre à huil" ,Toast.LENGTH_LONG).show();  
				                    else if(filtre_huil._kilometrage > nouveau_filtre_huil._kilometrage) Toast.makeText(getApplicationContext(), "Erreur saisie kilometrage dernier changement filtre à huil" ,Toast.LENGTH_LONG).show();
				              else  {  
				     				//test saisie filtre à air
		                	        ...
		                	        if(ancienne_date.after(nouvelle_date)) Toast.makeText(getApplicationContext(), "Erreur saisie date dernier changement filtre à air" ,Toast.LENGTH_LONG).show();  
				                    else if(filtre_air._kilometrage > nouveau_filtre_air._kilometrage) Toast.makeText(getApplicationContext(), "Erreur saisie kilometrage dernier changement filtre à air" ,Toast.LENGTH_LONG).show();
				              else  {
					            	...
					            	//test saisie courroie 
				                     ...
				                     if(ancienne_date.after(nouvelle_date)) Toast.makeText(getApplicationContext(), "Erreur saisie date dernier changement courroie crantée" ,Toast.LENGTH_LONG).show();  
						             else if(courroie._kilometrage > nouveau_courroie._kilometrage) Toast.makeText(getApplicationContext(), "Erreur saisie kilometrage dernier changement courroie crantée" ,Toast.LENGTH_LONG).show();
				              else  {
				            	   ...
				            	   //test visitte technique 
				                     ...
				                     if(ancienne_date.after(nouvelle_date)) Toast.makeText(getApplicationContext(), "Erreur saisie date dernière visite technique" ,Toast.LENGTH_LONG).show();  
						      else  { 
						    	   //test assurance 
